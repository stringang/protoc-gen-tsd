...
export interface IProtoMessageDescriptorModel {
  packageName: string;
  fileName: string;
  imports: string[];
...
export function format(descriptor: FileDescriptorProto, protoMap: ProtoAbstractSyntaxTreeMap): IProtoMessageDescriptorModel {
